...
const FetchConfigContext = _react.default.createContext({
  uri: "".concat(window.__REDWOOD__API_PROXY_PATH, "/graphql")
});
/**
...
const FetchConfigProvider = ({
  useAuth = (() => {
    var _window$__REDWOOD__US;

    return (_window$__REDWOOD__US = window.__REDWOOD__USE_AUTH) !== null && _window$__REDWOOD__US !== void 0 ? _window$__REDWOOD__US : () => ({
      loading: false,
