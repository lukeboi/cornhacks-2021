...
const getNewPath = (value, filename) => {
  ...
  if ((0, _internal.resolveFile)(_path.default.resolve(_path.default.dirname(filename), indexImportPath))) {
    ...
    if ((0, _internal.resolveFile)(_path.default.resolve(_path.default.dirname(filename), dirnameImportPath))) {
  ...
  return {
    visitor: {
      ImportDeclaration(p, state) {
        ...
        if (filename !== null && filename !== void 0 && (0, _includes.default)(filename).call(filename, '/node_modules/')) return; // We only need this plugin in the module could not be found.
