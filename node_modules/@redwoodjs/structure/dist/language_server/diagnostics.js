...
let DiagnosticsManager = (_dec = (0, _decorators.memo)(), _dec2 = (0, _decorators.debounce)(REFRESH_DIAGNOSTICS_DEBOUNCE), (_class = (_temp = class DiagnosticsManager {
  constructor(server) {
    this.server = server;
    this.previousURIs = [];
  }
...
}, _temp), ((0, _applyDecoratedDescriptor2.default)(_class.prototype, "start", [_dec], (0, _getOwnPropertyDescriptor.default)(_class.prototype, "start"), _class.prototype), (0, _applyDecoratedDescriptor2.default)(_class.prototype, "refreshDiagnostics", [_dec2], (0, _getOwnPropertyDescriptor.default)(_class.prototype, "refreshDiagnostics"), _class.prototype)), _class));
