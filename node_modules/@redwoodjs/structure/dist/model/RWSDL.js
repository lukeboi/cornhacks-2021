...
let RWSDL = (_dec = (0, _decorators.lazy)(), _dec2 = (0, _decorators.lazy)(), _dec3 = (0, _decorators.lazy)(), _dec4 = (0, _decorators.lazy)(), _dec5 = (0, _decorators.lazy)(), _dec6 = (0, _decorators.lazy)(), (_class = class RWSDL extends _ide.FileNode {
  ...
  get schemaStringNode() {
    ...
    if (!i) return undefined; // TODO: do we allow other kinds of strings? or just tagged literals?
  ...
  get implementableFields() {
    ...
    return (0, _Array.iter)(function* () {
      ...
      for (const def of ast.definitions) if (def.kind === 'ObjectTypeDefinition') if (def.name.value === 'Query' || def.name.value === 'Mutation') for (const field of (_def$fields = def.fields) !== null && _def$fields !== void 0 ? _def$fields : []) {
        var _def$fields;
