...
let RWRouter = (_dec = (0, _decorators.memo)(), _dec2 = (0, _decorators.memo)(), _dec3 = (0, _decorators.lazy)(), _dec4 = (0, _decorators.lazy)(), _dec5 = (0, _decorators.lazy)(), _dec6 = (0, _decorators.lazy)(), (_class = class RWRouter extends _ide.FileNode {
  ...
  getRoutePathForFilePath(filePath) {
    ...
    if (path !== null && path !== void 0 && (0, _includes.default)(path).call(path, '{')) return;
    return path;
  }
  /**
   * the <Router> tag
  ...
  get routes() {
    ...
    return (0, _Array.iter)(function* () {
      if (!self.jsxNode) return; // TODO: make sure that they are nested within the <Router> tag
      ...
      for (const x of self.sf.getDescendantsOfKind(tsm.SyntaxKind.JsxSelfClosingElement)) {
        ...
        if (tagName === 'Route') yield new _RWRoute.RWRoute(x, self);
      }
    });
  }
  ...
  get numNotFoundPages() {
    ...
    return (0, _filter.default)(_context4 = this.routes).call(_context4, r => r.isNotFound).length;
  }
  ...
  *ideInfo() {
  ...
  get quickFix_addNotFoundpage() {
    ...
    const p = (0, _find.default)(_context5 = this.parent.pages).call(_context5, p => p.basenameNoExt === 'NotFoundPage');
    ...
    const indent = (0, _repeat.default)(_context6 = ' ').call(_context6, lastRouteLoc.range.start.character);
