 ...
 */
let RedwoodCommandString = (_dec = (0, _decorators.lazy)(), _dec2 = (0, _decorators.lazy)(), (_class = (_temp = class RedwoodCommandString {
  /**
  ...
  constructor(original) {
    ...
    let v = original;
    if (typeof v !== 'string') throw new Error('redwood command must be a string');
...
}, _temp), ((0, _applyDecoratedDescriptor2.default)(_class.prototype, "parsed", [_dec], (0, _getOwnPropertyDescriptor.default)(_class.prototype, "parsed"), _class.prototype), (0, _applyDecoratedDescriptor2.default)(_class.prototype, "isInterceptable", [_dec2], (0, _getOwnPropertyDescriptor.default)(_class.prototype, "isInterceptable"), _class.prototype)), _class));
