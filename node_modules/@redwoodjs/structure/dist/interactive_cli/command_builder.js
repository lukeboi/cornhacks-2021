...
var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _temp;

function command_builder(opts) {
  return new CommandBuilder(opts).buildCommand();
}

let CommandBuilder = (_dec = (0, _decorators.memo)(), _dec2 = (0, _decorators.memo)(), _dec3 = (0, _decorators.lazy)(), _dec4 = (0, _decorators.memo)(), _dec5 = (0, _decorators.memo)(), _dec6 = (0, _decorators.memo)(), _dec7 = (0, _decorators.memo)(), _dec8 = (0, _decorators.memo)(), (_class = (_temp = class CommandBuilder {
  constructor(opts) {
    this.opts = opts;
  ...
  async generate(type) {
    switch (type) {
      ...
      case 'sdl':
        ...
        if (!opts) return; // TODO: serialize options
