...
async function redwood_gen_dry_run(opts) {
  ...
  if (!cmd.isComplete) throw new Error('cannot pass an interactive command straight to the redwood-cli. You must run it through the command_builder first'); // eslint-disable-next-line
