...
var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _dec9, _class2, _temp;
...
let RemoteTreeDataProviderImpl = (_dec9 = (0, _decorators.memo)(), (_class2 = (_temp = class RemoteTreeDataProviderImpl {
  ...
  async getTreeItem(id) {
    ...
    if (!item) throw new Error(`item not found for id ${id}`); //console.log('--->', item.treeItemOverTheWire)
...
}, _temp), ((0, _applyDecoratedDescriptor2.default)(_class2.prototype, "lazyInit", [_dec9], (0, _getOwnPropertyDescriptor.default)(_class2.prototype, "lazyInit"), _class2.prototype)), _class2));
...
function Command_cli(cmd, title = 'run...') {
  ...
  if (!((0, _startsWith.default)(cmd).call(cmd, 'rw') || (0, _startsWith.default)(cmd).call(cmd, 'redwood'))) cmd = 'redwood ' + cmd;
  return {
