...
let BaseNode = (_dec = (0, _decorators.lazy)(), _dec2 = (0, _decorators.memo)(), _dec3 = (0, _decorators.memo)(), _dec4 = (0, _decorators.memo)(), _dec5 = (0, _decorators.memo)(_stringify.default), _dec6 = (0, _decorators.memo)(_stringify.default), _dec7 = (0, _decorators.lazy)(), _dec8 = (0, _decorators.memo)(), (_class = (_temp = class BaseNode {
  constructor() {
    this.exists = true;
  }
  ...
  async collectIDEInfo(uri) {
    ...
    try {
      ...
      let all = [...d1, ...d2];
      if (uri) all = (0, _filter.default)(all).call(all, x => x.location.uri === uri);
      return all;
    } catch (e) {
  ...
  async collectDiagnostics(uri) {
    ...
    try {
      ...
      const d2 = (0, _flat.default)(dd).call(dd);
      let all = [...d1, ...d2];
      if (uri) all = (0, _filter.default)(all).call(all, x => x.uri === uri);
      return all;
    } catch (e) {
  ...
  bailOutOnCollection(uri) {
    ...
    if ((0, _startsWith.default)(uri).call(uri, this.id)) return false;
    return true;
  }
