...
const preRequisites = [{
  ...
  errorMessage: ['Looks like @netlify/zip-it-and-ship-it is not installed.', 'Either run `yarn rw g deploy aws_serverless` or add it seperately as a dev dependency in the api workspace.']
}];
