...
const command = 'api <provider>';
exports.command = command;
const description = 'Deploy the API using the selected provider';
...
const builder = yargs => {
  ...
  yargs.positional('provider', {
    ...
    type: 'string'
  }).epilogue(`Also see the ${(0, _terminalLink.default)('Redwood CLI Reference', 'https://redwoodjs.com/reference/command-line-interface#deploy-api')}`);
};
