...
const handler = async ({
  ...
  var _context3, _providerData$preRequ, _providerData$apiPack, _providerData$files, _providerData$gitIgno;
  ...
  }, (providerData === null || providerData === void 0 ? void 0 : (_providerData$apiPack = providerData.apiPackages) === null || _providerData$apiPack === void 0 ? void 0 : _providerData$apiPack.length) && {
    title: 'Adding required api packages...',
    task: async () => {
      await (0, _execa.default)('yarn', ['workspace', 'api', 'add', '-D', ...providerData.apiPackages]);
    }
  }, {
