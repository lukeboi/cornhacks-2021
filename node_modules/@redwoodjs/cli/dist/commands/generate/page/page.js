...
const description = 'Generate a page and route component';
...
const builder = yargs => {
  yargs.positional('name', {
    ...
    type: 'boolean',
    default: true
  }).epilogue(`Also see the ${(0, _terminalLink.default)('Redwood CLI Reference', 'https://redwoodjs.com/reference/command-line-interface#generate-page')}`);
};
...
const handler = async ({
  ...
  if (process.platform === 'win32') {
    ...
    try {
      ...
      const slashPath = (0, _trim.default)(_context2 = (0, _child_process.execSync)('cygpath -m /', {
        stdio: ['ignore', 'pipe', 'ignore']
      }).toString()).call(_context2); // `yarn rw g page home /` =>
