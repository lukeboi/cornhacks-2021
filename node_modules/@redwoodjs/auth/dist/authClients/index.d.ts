...
declare const typesToClients: {
    ...
    firebase: (client: typeof import("firebase")) => AuthClient;
...
export declare type SupportedAuthClients = Auth0 | AzureActiveDirectory | GoTrue | NetlifyIdentity | MagicLink | Firebase | Supabase | Custom;
...
export declare type SupportedUserMetadata = Auth0User | AzureActiveDirectoryUser | GoTrueUser | MagicUser | SupabaseUser;
