...
import type { AuthContextPayload } from "../auth/index";
import type { GlobalContext } from "../globalContext";
export declare type GetCurrentUser = (decoded: AuthContextPayload[0], raw: AuthContextPayload[1]) => Promise<null | Record<string, unknown> | string>;
/**
