...
const parseAuthorizationHeader = event => {
  ...
  const [schema, token] = (_event$headers = event.headers) === null || _event$headers === void 0 ? void 0 : (_event$headers$author = _event$headers.authorization) === null || _event$headers$author === void 0 ? void 0 : _event$headers$author.split(' ');
